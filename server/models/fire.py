...
class StageConfig(BaseModel):
    ...
    duration_sec: int = Field(
        default=1800,
        description="Base TTL for fires at this stage (seconds). Default 30 min.",
    )
...
STAGE_CONFIGS: dict[FireStage, StageConfig] = {
    ...
    FireStage.DAEHWAJAE: StageConfig(
        ...
        label_ko="대화재",
        label_en="big fire",
        threshold=30,          # 30-49 clicks — firefighter triggers here
        duration_sec=1800,
